...
$puck_4.Trait["$impl_test/cases/modules/export.puck:Trait$test/cases/modules/export.puck:Type"].implemented.call({type: '$impl_test/cases/modules/export.puck:Trait$test/cases/modules/export.puck:Type', value: f, $isTraitObject: true});
