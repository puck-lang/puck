  ...
  (0, _test.describe)("Option", function () {
    ...
    (0, _test.describe)("andThen", function () {
      (0, _test.it)("should map the value if Some(value) and returns Some(newValue)", function () {
        return (0, _test.expect)(any((0, _core.Some)(1).andThen(function (value) {
    ...
    (0, _test.describe)("map", function () {
      (0, _test.it)("should map the value if Some(value)", function () {
        (0, _test.expect)(any((0, _core.Some)(1).map(function (value) {
          return value + value;
        }))).toEqual(any((0, _core.Some)(2)));
        return (0, _test.expect)((0, _core.Some)(2).map(function (value) {
          return value + value;
        }).unwrap()).toBe(4);
      });
      return (0, _test.it)("should not call the map function if None", function () {
        return (0, _test.expect)(any(_core.None.map(function (value) {
          return (0, _test.expect)("map").toBe("not called");
        }))).toEqual(any(_core.None));
      });
    });
    (0, _test.describe)("mapOr", function () {
      (0, _test.it)("should map the value if Some(value)", function () {
        return (0, _test.expect)(any((0, _core.Some)(1).mapOr(5, function (value) {
          return value + value;
        }))).toBe(2);
      });
      return (0, _test.it)("should return the default value if None", function () {
        return (0, _test.expect)(any(_core.None.mapOr(5, function (value) {
          return (0, _test.expect)("map").toBe("not called");
        }))).toBe(5);
      });
    });
    (0, _test.describe)("mapOrElse", function () {
      (0, _test.it)("should map the value if Some(value)", function () {
        return (0, _test.expect)(any((0, _core.Some)(1).mapOrElse(function () {
      ...
      return (0, _test.it)("should return the result of the default function if None", function () {
        return (0, _test.expect)(any(_core.None.mapOrElse(function () {
          return 5;
        }, function (value) {
          return (0, _test.expect)("map").toBe("not called");
        }))).toBe(5);
    ...
    (0, _test.describe)("unwrap", function () {
      (0, _test.it)("should return the value if Some(value)", function () {
        return (0, _test.expect)((0, _core.Some)("value").unwrap()).toBe("value");
      });
      return (0, _test.it)("should panic if None", function () {
        return (0, _test.expect)(any(function () {
          return _core.None.unwrap();
        })).toThrow();
      });
    });
    (0, _test.describe)("unwrapOr", function () {
      (0, _test.it)("should return the value if Some(value)", function () {
        return (0, _test.expect)((0, _core.Some)("value").unwrapOr("default")).toBe("value");
      });
      return (0, _test.it)("should return the default value if None", function () {
        return (0, _test.expect)(_core.None.unwrapOr("default")).toBe("default");
      });
    });
    return (0, _test.describe)("unwrapOrElse", function () {
      (0, _test.it)("should return the value if Some(value)", function () {
        return (0, _test.expect)((0, _core.Some)("value").unwrapOrElse(function () {
          return (0, _test.expect)("orElse").toBe("not called");
        })).toBe("value");
      });
      return (0, _test.it)("should return the result of the default function if None", function () {
        return (0, _test.expect)(_core.None.unwrapOrElse(function () {
          return "default";
        })).toBe("default");
      });
    });
  ...
  return (0, _test.describe)("Result", function () {
    ...
    (0, _test.describe)("map", function () {
      (0, _test.it)("should map the value if Ok(value)", function () {
        (0, _test.expect)(any((0, _core.Ok)(1).map(function (value) {
          return value + value;
        }))).toEqual(any((0, _core.Ok)(2)));
        return (0, _test.expect)((0, _core.Ok)(2).map(function (value) {
          return value + value;
        }).unwrap()).toBe(4);
      });
      return (0, _test.it)("should not call the map function if Err(err)", function () {
        return (0, _test.expect)(any((0, _core.Err)(2).map(function (value) {
          return (0, _test.expect)("map").toBe("not called");
        }))).toEqual(any((0, _core.Err)(2)));
      });
    });
    (0, _test.describe)("mapErr", function () {
      (0, _test.it)("should map the value if Ok(value)", function () {
        (0, _test.expect)(any((0, _core.Err)(1).mapErr(function (value) {
          return value + value;
        }))).toEqual(any((0, _core.Err)(2)));
        return (0, _test.expect)((0, _core.Err)(2).mapErr(function (value) {
          return value + value;
        }).unwrapErr()).toBe(4);
      });
      return (0, _test.it)("should not call the mapErr function if Err(err)", function () {
        return (0, _test.expect)(any((0, _core.Ok)(2).mapErr(function (value) {
    ...
    (0, _test.describe)("unwrap", function () {
      (0, _test.it)("should return the value if Ok(value)", function () {
        return (0, _test.expect)((0, _core.Ok)("value").unwrap()).toBe("value");
      });
      return (0, _test.it)("should panic if Err(err)", function () {
        return (0, _test.expect)(any(function () {
          return (0, _core.Err)("err").unwrap();
        })).toThrow();
      });
    });
    return (0, _test.describe)("unwrapErr", function () {
      (0, _test.it)("should panic if Ok(value)", function () {
        return (0, _test.expect)(any(function () {
          return (0, _core.Ok)("value").unwrapErr();
        })).toThrow();
      });
      return (0, _test.it)("should return the error if Err(err)", function () {
        return (0, _test.expect)((0, _core.Err)("err").unwrapErr()).toBe("err");
      });
    });
  });
});
