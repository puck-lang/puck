...
exports.ScopeAware = exports.Scope = exports.TypeBinding = exports.Binding = exports.TypeParameter = exports.TypeInstance = exports.TypeClass = exports.Implementation = exports.Tuple = exports.Record = exports.StructKind = exports.Trait = exports.Struct = exports.Function = exports.Enum = exports.TypeKind = exports.Type = exports.File = exports.TypeClassTrait = exports.TypeTrait = undefined;
...
var TypeTrait = exports.TypeTrait = {
  displayName: function displayName() {
    ...
    if (__PUCK__value__3.kind == "Enum") {
      ...
      return getGenericName(_core.MaybeTrait['$Option'].unwrap.call(self.name), self);
    } else {
      ...
      if (__PUCK__value__4.kind == "Function") {
        var _ret = function () {
          ...
          return {
            v: _core.MaybeTrait['$Option'].unwrapOrElse.call(self.name, function () {
        ...
        if (__PUCK__value__5.kind == "Parameter") {
          ...
          return _core.MaybeTrait['$Option'].unwrap.call(self.name);
        } else {
          ...
          if (__PUCK__value__7.kind == "Struct") {
            var _ret2 = function () {
              ...
              return {
                v: _core.MaybeTrait['$Option'].mapOrElse.call(self.name, function () {
            ...
            if (__PUCK__value__12.kind == "Trait") {
              ...
              return getGenericName(_core.MaybeTrait['$Option'].unwrap.call(self.name), self, true);
            };
          };
        };
      };
...
var TypeClassTrait = exports.TypeClassTrait = {
  fromAstNode: function fromAstNode(astNode, reportError) {
...
function getFunctionTypeName(_function) {
  return getTupleTypeName(_core.Iterable['$List'].map.call(_function._arguments, function (a) {
    return a.type_;
  })) + " -> " + (_function.returnType && TypeTrait['$Type'].displayName.call(_function.returnType));
};
function getTupleTypeName(properties) {
  return "(" + _core.Iterable['$List'].map.call(properties, function (type_) {
    return TypeTrait['$Type'].displayName.call(type_);
  }).join(", ") + ")";
};
...
function getGenericName(name, type_) {
  ...
  if (__PUCK__value__14.kind == "Some") {
    ...
    var instance = _PUCK__value__14$val[0];

    return name + "<" + instance.typeParameters.map(function (p) {
      return TypeTrait['$Type'].displayName.call(p);
    }).join(", ") + ">";
  } else {
    if (showClassParameters) {
      ...
      if (__PUCK__value__15.kind == "Some") {
        ...
        var _class = _PUCK__value__15$val[0];
