...
(function (SyntaxKind) {
    ...
    SyntaxKind[SyntaxKind["TupleTypeBound"] = 68] = "TupleTypeBound";
    SyntaxKind[SyntaxKind["TypeDeclaration"] = 69] = "TypeDeclaration";
    SyntaxKind[SyntaxKind["TypeParameter"] = 70] = "TypeParameter";
    SyntaxKind[SyntaxKind["TypeProperty"] = 71] = "TypeProperty";
    SyntaxKind[SyntaxKind["VariableDeclaration"] = 72] = "VariableDeclaration";
    SyntaxKind[SyntaxKind["ExportDirective"] = 73] = "ExportDirective";
    SyntaxKind[SyntaxKind["ImportDirective"] = 74] = "ImportDirective";
    SyntaxKind[SyntaxKind["AssignmentExpression"] = 75] = "AssignmentExpression";
    SyntaxKind[SyntaxKind["BinaryExpression"] = 76] = "BinaryExpression";
    SyntaxKind[SyntaxKind["CallExpression"] = 77] = "CallExpression";
    SyntaxKind[SyntaxKind["ForExpression"] = 78] = "ForExpression";
    SyntaxKind[SyntaxKind["IfExpression"] = 79] = "IfExpression";
    SyntaxKind[SyntaxKind["LoopExpression"] = 80] = "LoopExpression";
    SyntaxKind[SyntaxKind["UnaryExpression"] = 81] = "UnaryExpression";
    SyntaxKind[SyntaxKind["WhileExpression"] = 82] = "WhileExpression";
    SyntaxKind[SyntaxKind["IndexAccess"] = 83] = "IndexAccess";
    SyntaxKind[SyntaxKind["MemberAccess"] = 84] = "MemberAccess";
    SyntaxKind[SyntaxKind["BreakStatement"] = 85] = "BreakStatement";
    SyntaxKind[SyntaxKind["ReturnStatement"] = 86] = "ReturnStatement";
    SyntaxKind[SyntaxKind["BooleanLiteral"] = 87] = "BooleanLiteral";
    SyntaxKind[SyntaxKind["ListLiteral"] = 88] = "ListLiteral";
    SyntaxKind[SyntaxKind["NumberLiteral"] = 89] = "NumberLiteral";
    SyntaxKind[SyntaxKind["ObjectLiteral"] = 90] = "ObjectLiteral";
    SyntaxKind[SyntaxKind["StringLiteral"] = 91] = "StringLiteral";
    SyntaxKind[SyntaxKind["TupleLiteral"] = 92] = "TupleLiteral";
    SyntaxKind[SyntaxKind["ObjectLiteralMember"] = 93] = "ObjectLiteralMember";
    SyntaxKind[SyntaxKind["StringLiteralPart"] = 94] = "StringLiteralPart";
