...
(function (SyntaxKind) {
    ...
    SyntaxKind[SyntaxKind["NamedTypeBound"] = 62] = "NamedTypeBound";
    SyntaxKind[SyntaxKind["FunctionTypeBound"] = 63] = "FunctionTypeBound";
    SyntaxKind[SyntaxKind["TypeDeclaration"] = 64] = "TypeDeclaration";
    SyntaxKind[SyntaxKind["TypeParameter"] = 65] = "TypeParameter";
    SyntaxKind[SyntaxKind["TypeProperty"] = 66] = "TypeProperty";
    SyntaxKind[SyntaxKind["VariableDeclaration"] = 67] = "VariableDeclaration";
    SyntaxKind[SyntaxKind["ExportDirective"] = 68] = "ExportDirective";
    SyntaxKind[SyntaxKind["ImportDirective"] = 69] = "ImportDirective";
    SyntaxKind[SyntaxKind["AssignmentExpression"] = 70] = "AssignmentExpression";
    SyntaxKind[SyntaxKind["BinaryExpression"] = 71] = "BinaryExpression";
    SyntaxKind[SyntaxKind["CallExpression"] = 72] = "CallExpression";
    SyntaxKind[SyntaxKind["ForExpression"] = 73] = "ForExpression";
    SyntaxKind[SyntaxKind["IfExpression"] = 74] = "IfExpression";
    SyntaxKind[SyntaxKind["LoopExpression"] = 75] = "LoopExpression";
    SyntaxKind[SyntaxKind["UnaryExpression"] = 76] = "UnaryExpression";
    SyntaxKind[SyntaxKind["WhileExpression"] = 77] = "WhileExpression";
    SyntaxKind[SyntaxKind["IndexAccess"] = 78] = "IndexAccess";
    SyntaxKind[SyntaxKind["MemberAccess"] = 79] = "MemberAccess";
    SyntaxKind[SyntaxKind["BreakStatement"] = 80] = "BreakStatement";
    SyntaxKind[SyntaxKind["ReturnStatement"] = 81] = "ReturnStatement";
    SyntaxKind[SyntaxKind["ArrayLiteral"] = 82] = "ArrayLiteral";
    SyntaxKind[SyntaxKind["BooleanLiteral"] = 83] = "BooleanLiteral";
    SyntaxKind[SyntaxKind["NumberLiteral"] = 84] = "NumberLiteral";
    SyntaxKind[SyntaxKind["ObjectLiteral"] = 85] = "ObjectLiteral";
    SyntaxKind[SyntaxKind["StringLiteral"] = 86] = "StringLiteral";
    SyntaxKind[SyntaxKind["ObjectLiteralMember"] = 87] = "ObjectLiteralMember";
    SyntaxKind[SyntaxKind["StringLiteralPart"] = 88] = "StringLiteralPart";
