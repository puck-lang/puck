...
function getTypeId(declaration, context, file) {
  ...
  var __PUCK__value__10 = _core.Iterable["$impl_lib/stdlib/core.puck:Iterable$List"].find.call({ type: '$impl_lib/stdlib/core.puck:Iterable$List', value: declaration.attributes, $isTraitObject: true }, function (a) {
  ...
  if ($unwrapTraitObject(__PUCK__value__10).kind == "Some") {
    var _$unwrapTraitObject4 = $unwrapTraitObject(__PUCK__value__10),
        ...
        attribute = _$unwrapTraitObject4$[0];

    var __PUCK__value__11 = attribute.data;
    var __PUCK__value__12 = __PUCK__value__11;
    if ($unwrapTraitObject(__PUCK__value__12).kind == "Value") {
      var _$unwrapTraitObject5 = $unwrapTraitObject(__PUCK__value__12),
          _$unwrapTraitObject5$ = _slicedToArray(_$unwrapTraitObject5.value, 1),
          literal = _$unwrapTraitObject5$[0];

      var __PUCK__value__13 = literal;
      var __PUCK__value__14 = __PUCK__value__13;
      if ($unwrapTraitObject(__PUCK__value__14).kind == "StringLiteral") {
        var _$unwrapTraitObject6 = $unwrapTraitObject(__PUCK__value__14),
            _$unwrapTraitObject6$ = _slicedToArray(_$unwrapTraitObject6.value, 1),
            value = _$unwrapTraitObject6$[0].value;
      ...
      var __PUCK__value__17 = __PUCK__value__11;
      if (true) {
  ...
  return $unwrapTraitObject(_js._Object).assign({}, visit.emptyVisitor, structureVisitorInstance, {
      ...
      _core.Iterable["$impl_lib/stdlib/core.puck:Iterable$List"].forEach.call({ type: '$impl_lib/stdlib/core.puck:Iterable$List', value: m.statements, $isTraitObject: true }, function (s) {
        ...
        if ($unwrapTraitObject(__PUCK__value__20).kind == "EnumDeclaration") {
          var _$unwrapTraitObject7 = $unwrapTraitObject(__PUCK__value__20),
              ...
              __PUCK__value__21 = _$unwrapTraitObject7$[0];

          return _core.List.add.call(declarations, s);
        } else {
          var __PUCK__value__22 = __PUCK__value__19;
          if ($unwrapTraitObject(__PUCK__value__22).kind == "ImportDirective") {
            var _$unwrapTraitObject8 = $unwrapTraitObject(__PUCK__value__22),
                ...
                i = _$unwrapTraitObject8$[0];

            return _core.List.add.call(imports, i);
          } else {
            var __PUCK__value__23 = __PUCK__value__19;
            if ($unwrapTraitObject(__PUCK__value__23).kind == "TraitDeclaration") {
              var _$unwrapTraitObject9 = $unwrapTraitObject(__PUCK__value__23),
                  ...
                  __PUCK__value__24 = _$unwrapTraitObject9$[0];

              return _core.List.add.call(declarations, s);
            } else {
              var __PUCK__value__25 = __PUCK__value__19;
              if ($unwrapTraitObject(__PUCK__value__25).kind == "TypeDeclaration") {
                var _$unwrapTraitObject10 = $unwrapTraitObject(__PUCK__value__25),
                    _$unwrapTraitObject11 = _slicedToArray(_$unwrapTraitObject10.value, 1),
                    __PUCK__value__26 = _$unwrapTraitObject11[0];

                return _core.List.add.call(declarations, s);
              } else {
                var __PUCK__value__27 = __PUCK__value__19;
                if ($unwrapTraitObject(__PUCK__value__27).kind == "ExportDirective") {
                  var _$unwrapTraitObject12 = $unwrapTraitObject(__PUCK__value__27),
                      _$unwrapTraitObject13 = _slicedToArray(_$unwrapTraitObject12.value, 1),
                      e = _$unwrapTraitObject13[0];

                  var __PUCK__value__28 = e.statement;
                  var __PUCK__value__29 = __PUCK__value__28;
                  if ($unwrapTraitObject(__PUCK__value__29).kind == "EnumDeclaration") {
                    var _$unwrapTraitObject14 = $unwrapTraitObject(__PUCK__value__29),
                        ...
                        __PUCK__value__30 = _$unwrapTraitObject15[0];

                    return _core.List.add.call(declarations, s);
                  } else {
                    var __PUCK__value__31 = __PUCK__value__28;
                    if ($unwrapTraitObject(__PUCK__value__31).kind == "TraitDeclaration") {
                      var _$unwrapTraitObject16 = $unwrapTraitObject(__PUCK__value__31),
                          ...
                          __PUCK__value__32 = _$unwrapTraitObject17[0];

                      return _core.List.add.call(declarations, s);
                    } else {
                      var __PUCK__value__33 = __PUCK__value__28;
                      if ($unwrapTraitObject(__PUCK__value__33).kind == "TypeDeclaration") {
                        var _$unwrapTraitObject18 = $unwrapTraitObject(__PUCK__value__33),
                            ...
                            __PUCK__value__34 = _$unwrapTraitObject19[0];
                        ...
                        if (true) {
                          ...
                          return __PUCK__value__36;
                        };
                      };
                    };
                  };
                } else {
                  var __PUCK__value__38 = __PUCK__value__19;
                  if (true) {
                    var __PUCK__value__39 = __PUCK__value__38;;
                    var __PUCK__value__40 = __PUCK__value__39;;
                    return __PUCK__value__39;
                  };
                };
              };
            };
    ...
    visitEnumDeclaration: function visitEnumDeclaration(t) {
      ...
      if (!t.type_) {
        ...
        var __PUCK__value__41 = _scope.Scope.define.call(parentScope, {
          name: t.name.name,
          token: token,
          mutable: false,
        ...
        if ($unwrapTraitObject(__PUCK__value__41).kind == "Err") {
          var _$unwrapTraitObject20 = $unwrapTraitObject(__PUCK__value__41),
        ...
        if (!t.scope) {
          ...
          var __PUCK__value__42 = _core.Option.unwrap.call(type_.providesType)._class;
          ...
          var __PUCK__value__43 = _core.Option.unwrap.call(type_.providesType).kind;
    ...
    visitTraitDeclaration: function visitTraitDeclaration(t) {
      ...
      if (!t.type_) {
        ...
        var __PUCK__value__44 = _scope.Scope.define.call(parentScope, {
          name: t.name.name,
          token: token,
          mutable: false,
          allowRedeclare: false,
        ...
        if ($unwrapTraitObject(__PUCK__value__44).kind == "Err") {
          var _$unwrapTraitObject26 = $unwrapTraitObject(__PUCK__value__44),
              _$unwrapTraitObject27 = _slicedToArray(_$unwrapTraitObject26.value, 1),
              error = _$unwrapTraitObject27[0];
        ...
        if (!t.scope) {
          ...
          t.scope = scope;
          $unwrapTraitObject(self).scope = scope;
          var __PUCK__value__45 = _core.Option.unwrap.call(type_.providesType)._class;
          if ($unwrapTraitObject(__PUCK__value__45).kind == "Some") {
            (function () {
              var _$unwrapTraitObject28 = $unwrapTraitObject(__PUCK__value__45),
          ...
          var __PUCK__value__46 = _core.Option.unwrap.call(type_.providesType).kind;
          if ($unwrapTraitObject(__PUCK__value__46).kind == "Trait") {
            (function () {
              var _$unwrapTraitObject30 = $unwrapTraitObject(__PUCK__value__46),
                  ...
                  trait_ = _$unwrapTraitObject31[0];
              ...
              $unwrapTraitObject(_js._Object).assign(trait_.functions, _core.ObjectMap.fromIter(_core.Iterable["$impl_lib/stdlib/core.puck:Iterable$List"].map.call({ type: '$impl_lib/stdlib/core.puck:Iterable$List', value: t.members, $isTraitObject: true }, function (m) {
                var __PUCK__value__47 = m.type_.kind;
                if ($unwrapTraitObject(__PUCK__value__47).kind == "Function") {
                  var _$unwrapTraitObject32 = $unwrapTraitObject(__PUCK__value__47),
                      ...
                      _function = _$unwrapTraitObject33[0];
              ...
              var __PUCK__value__48 = _core.Option.unwrap.call(type_.providesType)._class;
              if ($unwrapTraitObject(__PUCK__value__48).kind == "Some") {
                var _$unwrapTraitObject34 = $unwrapTraitObject(__PUCK__value__48),
                    _$unwrapTraitObject35 = _slicedToArray(_$unwrapTraitObject34.value, 1),
                    _class = _$unwrapTraitObject35[0];
                ...
                _core.Iterable["$impl_lib/stdlib/core.puck:Iterable$List"].forEach.call({ type: '$impl_lib/stdlib/core.puck:Iterable$List', value: _class.instances, $isTraitObject: true }, function (instance) {
                  var __PUCK__value__49 = instance.kind;
                  if ($unwrapTraitObject(__PUCK__value__49).kind == "Trait") {
                    var _$unwrapTraitObject36 = $unwrapTraitObject(__PUCK__value__49),
                        _$unwrapTraitObject37 = _slicedToArray(_$unwrapTraitObject36.value, 1),
                        instanceTrait = _$unwrapTraitObject37[0];
    ...
    visitTypeDeclaration: function visitTypeDeclaration(t) {
      ...
      var type_ = t.type_;
      if (!t.type_) {
        var __PUCK__value__50 = t.bound;
        var __PUCK__value__51 = void 0;
        if ($unwrapTraitObject(__PUCK__value__50).kind == "Some") {
          var _$unwrapTraitObject38 = $unwrapTraitObject(__PUCK__value__50),
              _$unwrapTraitObject39 = _slicedToArray(_$unwrapTraitObject38.value, 1),
              typeBound = _$unwrapTraitObject39[0];

          var __PUCK__value__52 = typeBound;
          var __PUCK__value__53 = __PUCK__value__52;
          var __PUCK__value__54 = void 0;
          if ($unwrapTraitObject(__PUCK__value__53).kind == "RecordTypeBound") {
            var _$unwrapTraitObject40 = $unwrapTraitObject(__PUCK__value__53),
                _$unwrapTraitObject41 = _slicedToArray(_$unwrapTraitObject40.value, 1),
                record = _$unwrapTraitObject41[0];

            __PUCK__value__54 = _entities.StructKind.Record({ properties: _core.ObjectMap._new() });
          } else {
            var __PUCK__value__55 = __PUCK__value__52;
            var __PUCK__value__56 = void 0;
            if ($unwrapTraitObject(__PUCK__value__55).kind == "TupleTypeBound") {
              var _$unwrapTraitObject42 = $unwrapTraitObject(__PUCK__value__55),
                  _$unwrapTraitObject43 = _slicedToArray(_$unwrapTraitObject42.value, 1),
                  tuple = _$unwrapTraitObject43[0];

              __PUCK__value__56 = _entities.StructKind.Tuple({ properties: [] });
            } else {
              var __PUCK__value__57 = __PUCK__value__52;
              var __PUCK__value__58 = void 0;
              if (true) {
                var __PUCK__value__59 = __PUCK__value__57;
                throw "Unreachable";
              };
              __PUCK__value__56 = __PUCK__value__58;
            };
            __PUCK__value__54 = __PUCK__value__56;
          };
          __PUCK__value__51 = __PUCK__value__54;
        } else {
          __PUCK__value__51 = _entities.StructKind.Unit;
        };
        var structKind = __PUCK__value__51;
        t.type_ = _entities.Type.provides({
          id: getTypeId(t, context, file),
          displayName: _core.None,
          name: (0, _core.Some)(t.name.name),
        ...
        var __PUCK__value__60 = _scope.Scope.define.call(parentScope, {
          name: t.name.name,
          token: token,
          mutable: false,
          allowRedeclare: false,
        ...
        if ($unwrapTraitObject(__PUCK__value__60).kind == "Err") {
        ...
        if (!t.scope) {
          ...
          t.scope = scope;
          $unwrapTraitObject(self).scope = scope;
          var __PUCK__value__61 = _core.Option.unwrap.call(type_.providesType)._class;
          ...
          if ($unwrapTraitObject(__PUCK__value__62).kind == "Some") {
            ...
            var __PUCK__value__63 = _core.Option.unwrap.call(type_.providesType).kind;
            var __PUCK__value__64 = __PUCK__value__63;
            if ($unwrapTraitObject(__PUCK__value__64).kind == "Struct" && $unwrapTraitObject($unwrapTraitObject($unwrapTraitObject($unwrapTraitObject(__PUCK__value__64).value)[$unwrapTraitObject(0)]).kind).kind == "Record") {
              ...
              if ($unwrapTraitObject(__PUCK__value__65).kind == "Struct" && $unwrapTraitObject($unwrapTraitObject($unwrapTraitObject($unwrapTraitObject(__PUCK__value__65).value)[$unwrapTraitObject(0)]).kind).kind == "Tuple") {
                var _$unwrapTraitObject53 = $unwrapTraitObject(__PUCK__value__65),
                ...
                var __PUCK__value__66 = _core.Iterable["$impl_lib/stdlib/core.puck:Iterable$List"].map.call({ type: '$impl_lib/stdlib/core.puck:Iterable$List', value: _ast.TypeBound.getTupleTypeBound.call(_typeBound).properties, $isTraitObject: true }, function (p) {
                  return _ast.TypeBound.getType.call(p);
                });
                $unwrapTraitObject(_js._Object).assign(_tuple, { properties: _core.Iterable[__PUCK__value__66.type].toList.call(__PUCK__value__66) });
              } else {
    ...
    visitImportDirective: function visitImportDirective(importDirective) {
      ...
      var __PUCK__value__69 = importDirective._module;
      ...
      var __PUCK__value__70 = importDirective.specifier;
      var __PUCK__value__71 = __PUCK__value__70;
      if ($unwrapTraitObject(__PUCK__value__71).kind == "Identifier") {
        var _ret6 = function () {
          var _$unwrapTraitObject58 = $unwrapTraitObject(__PUCK__value__71),
          ...
          var __PUCK__value__72 = importDirective._module;
          ...
          if ($unwrapTraitObject(__PUCK__value__72).kind == "Some") {
            ...
            __PUCK__value__73 = _core.ObjectMap.map.call(_module2.exports, function (exportDirective) {
              return _ast.ExportDirective.getType.call(exportDirective);
            });
          } else {
            __PUCK__value__73 = _core.ObjectMap._new();
          };
          var typeProperties = __PUCK__value__73;
          ...
          var __PUCK__value__74 = _scope.Scope.define.call(scope, {
            ...
            completeType: _core.Option.map.call(importDirective._module, function (_module) {
              return function (visitor) {
                ...
                var __PUCK__value__75 = type_.kind;
                var __PUCK__value__76 = __PUCK__value__75;
                if ($unwrapTraitObject(__PUCK__value__76).kind == "Struct" && $unwrapTraitObject($unwrapTraitObject($unwrapTraitObject($unwrapTraitObject(__PUCK__value__76).value)[$unwrapTraitObject(0)]).kind).kind == "Record") {
          ...
          if ($unwrapTraitObject(__PUCK__value__74).kind == "Err") {
            var _$unwrapTraitObject65 = $unwrapTraitObject(__PUCK__value__74),
        ...
        if ($unwrapTraitObject(__PUCK__value__79).kind == "ObjectDestructure") {
          ...
          return _core.Iterable["$impl_lib/stdlib/core.puck:Iterable$List"].forEach.call({ type: '$impl_lib/stdlib/core.puck:Iterable$List', value: d.members, $isTraitObject: true }, function (m) {
            ...
            var __PUCK__value__80 = importDirective._module;
            if ($unwrapTraitObject(__PUCK__value__80).kind == "Some") {
              var _ret7 = function () {
                var _$unwrapTraitObject69 = $unwrapTraitObject(__PUCK__value__80),
                ...
                var __PUCK__value__81 = _scope.Scope.define.call(scope, {
                  name: m.local.name,
                  token: token,
                  mutable: false,
                  allowRedeclare: false,
                ...
                if ($unwrapTraitObject(__PUCK__value__81).kind == "Err") {
                  var _$unwrapTraitObject71 = $unwrapTraitObject(__PUCK__value__81),
              ...
              var __PUCK__value__82 = _scope.Scope.define.call(scope, {
                name: m.local.name,
                token: token,
                mutable: false,
                allowRedeclare: false,
              ...
              if ($unwrapTraitObject(__PUCK__value__82).kind == "Err") {
                var _$unwrapTraitObject73 = $unwrapTraitObject(__PUCK__value__82),
          ...
          var __PUCK__value__83 = __PUCK__value__70;
          if ($unwrapTraitObject(__PUCK__value__83).kind == "Asterisk") {
            var __PUCK__value__84 = $unwrapTraitObject(__PUCK__value__83);;

            var _PUCK__value__84$val = _slicedToArray(__PUCK__value__84.value, 1),
                __PUCK__value__85 = _PUCK__value__84$val[0];

            ;
            return __PUCK__value__84;
          };
        };
      };
    },
    ...
    visitNamedTypeBound: function visitNamedTypeBound(t) {
      ...
      var __PUCK__value__86 = result;
      var __PUCK__value__87 = __PUCK__value__86;
      if ($unwrapTraitObject(__PUCK__value__87).kind == "Ok") {
        var _$unwrapTraitObject75 = $unwrapTraitObject(__PUCK__value__87),
        ...
        if ($unwrapTraitObject(__PUCK__value__88).kind == "Err") {
          var _$unwrapTraitObject77 = $unwrapTraitObject(__PUCK__value__88),
